...
export const apiQueryKeys = {
  ...
  curatorDrugClasses: (filters: Record<string, unknown>) =>
    [...apiQueryKeys.all, "curator-drug-classes", filters] as const,
  ...
  demoRequests: (status = "pending") =>
    [...apiQueryKeys.all, "demo-requests", status] as const,
